        ...
        void getBookByID()
        {
            try
            {
                ...
                if(dt.Rows.Count >= 1)
                {
                    ...
                    TextBox10.Text = dt.Rows[0][8].ToString().Trim();
                    TextBox11.Text = dt.Rows[0][9].ToString().Trim();
                    TextBox4.Text = dt.Rows[0][11].ToString().Trim();
                    TextBox5.Text = dt.Rows[0][12].ToString().Trim();
                    TextBox7.Text = "" + (Convert.ToInt32(dt.Rows[0][11].ToString()) - Convert.ToInt32(dt.Rows[0][12].ToString()));
