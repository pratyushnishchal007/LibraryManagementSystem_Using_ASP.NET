            ...
            <div class="card">
               <div class="card-body">
                  ...
                  <div class="row">
                     <div class="col">
                        <center>
                           <img id="imgview" width="100" src="book_inventory/books1.png" height="150" width="100" />
                        </center>
                     </div>
                  </div>
                  <div class="row">
                        ...
                        <div class="form-group">
                           <div class="input-group">
                              <asp:TextBox CssClass="form-control" ID="TextBox1" runat="server" placeholder="ID"></asp:TextBox>
                               <asp:Button ID="Button4" runat="server" Text="GO" class="btn btn-primary" OnClick="Button4_Click" />
                           </div>
                        </div>
                     </div>
                     <div class="col-md-8">
                  ...
                  <div class="row mt-2">
                     <div class="col-4">
                        <asp:Button ID="Button1" class="btn btn-lg btn-success w-100" runat="server" Text="Add" OnClick="Button1_Click" />
                     </div>
                     <div class="col-4">
                        <asp:Button ID="Button3" class="btn btn-lg btn-warning w-100" runat="server" Text="Update" OnClick="Button3_Click" />
                     </div>
                     <div class="col-4">
                        <asp:Button ID="Button2" class="btn btn-lg btn-danger w-100" runat="server" Text="Delete" OnClick="Button2_Click" />
                     </div>
                  </div>
               </div>
            </div>
               ...
               <div class="card-body">
                  ...
                  <div class="row">
                     ...
                     <div class="col">
                        ...
                        <asp:GridView class="table table-striped table-bordered table-condensed table-hover" ID="GridView1" runat="server" AutoGenerateColumns="False" DataKeyNames="book_id" DataSourceID="SqlDataSource1">
                            <Columns>
