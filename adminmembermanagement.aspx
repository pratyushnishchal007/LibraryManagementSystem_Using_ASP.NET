               ...
               <div class="card-body">
                     ...
                     <div class="col-md-4">
                        ...
                        <div class="form-group">
                           <div class="input-group">
                              ...
                              <asp:LinkButton class="btn btn-primary" ID="LinkButton4" runat="server" OnClick="LinkButton4_Click"><i class="fas fa-check-circle" OnClick="LinkButton4_Click"></i></asp:LinkButton>
                           </div>
                        </div>
                     </div>
                     <div class="col-md-4">
                  ...
                  <div class="row">
                     <div class="col-8">
                        ...
                        <asp:Button ID="Button2" class="btn btn-lg btn-danger mx-auto d-block mt-2" runat="server" Text="Delete User Permanently" OnClick="Button2_Click" />
               ...
               <div class="card-body">
                  ...
                  <div class="row">
                     ...
                     <div class="col">
                        ...
                        <asp:GridView class="table table-striped table-bordered table-condensed" ID="GridView1" runat="server" AutoGenerateColumns="False" DataKeyNames="member_id" DataSourceID="SqlDataSource1">
                            <Columns>
